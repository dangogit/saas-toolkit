...
A Claude Code plugin with everything you need to build, launch, and grow a SaaS product. 13 skills and a SaaS mentor agent covering your full stack - from bootstrapping to launch day.
...
```
  Validate idea
    ...
    /ai-integration --> Add AI features
       |
    /api-integration -> Connect payments + email
       |
